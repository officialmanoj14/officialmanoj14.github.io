        ...
        <div className="section" data-aos="fade-right">
          ...
          <div className="about">
            <div className="about_logoCont">
              <img
                src= "https://avatars.githubusercontent.com/u/105919715?v=4"
                alt="Images"
              />
            </div>
            <div className="about_dataCont" style={{textAlign:"left", fontWeight:'bolder', color:'#4A5568'}}>
              <h4 >
                Hi Everyone, I am{" "}
                <span style={{color:'#00A3C4'}}>Manoj Kumar Murmu </span> from{" "}Dhanbad, Jharkhand. A passionate Full Stack web developer specializing in {" "}
